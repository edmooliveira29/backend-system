...
describe('Email Validation', () => {
  ...
  it('Should return false if password more then 8 caractheres', () => {
  ...
  it('Should return false if password is not includes numerics digits', () => {
  ...
  it('Should return false if password is not includes uppercase letter', () => {
  ...
  it('Should return false if password is not includes lowercase letter', () => {
    user.password = 'PASSWORD1*'
    expect(validateMock.passwordIsValid(user.password)).toStrictEqual({
      passwordIsValid: false,
  ...
  it('Should return false if password is not includes special characters', () => {
    user.password = 'Password1'
  ...
  it('Should return true if password is equal', async () => {
    expect(await validateMock.comparePassword('password', await validateMock.hashPassword('password')))
